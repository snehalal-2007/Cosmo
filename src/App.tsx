 ...
 * AppNav switches between Solar System and Constellations mode.
 */
import './index.css'
import { Canvas } from '@react-three/fiber'
import { Scene } from './components/canvas'
import { HUD, TimeControlPanel, InfoPanel, MiniMap, PlanetNav, AppNav } from './components/ui'
import { ConstellationsPage } from './components/constellations'
...
function App() {
  ...
  return (
    <div className="fixed inset-0 bg-black">
      ...
      {appView === 'constellations' && <ConstellationsPage />}
    </div>
  )
}
